...
CREATE TABLE users (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT email_must_be_companys_email CHECK (((email)::text ~* '[A-Za-z0-9._%]+@example.com'::text))
);
...
INSERT INTO schema_migrations (version) VALUES ('20150730225403');

INSERT INTO schema_migrations (version) VALUES ('20150807232327');

INSERT INTO schema_migrations (version) VALUES ('20150808042859');

INSERT INTO schema_migrations (version) VALUES ('20150818235635');
